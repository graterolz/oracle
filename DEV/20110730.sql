...
CREATE INDEX "MIGRA"."PK_HJPF02_F1" ON "MIGRA"."HJPF02" (
	"RAMO","POLIZA","STSREC","NUMREC","DIADES","MESDES",
	"ANODES","DIAHAS","MESHAS","ANOHAS"
);
CREATE INDEX "MIGRA"."IDX_RAMPOLSTS" ON "MIGRA"."HJPF02" ("RAMO","POLIZA","STSSIT")
CREATE INDEX "MIGRA"."IDX_RAPODESHAS" ON "MIGRA"."HJPF02" (
	"RAMO","POLIZA","DIADES","MESDES",
	"ANODES","DIAHAS","MESHAS","ANOHAS"
);
CREATE INDEX "MIGRA"."PK_HJPF02_FEC2" ON "MIGRA"."HJPF02" (
	"RAMO","POLIZA",
	"ANODES" * 10000 + "MESDES" * 100 + "DIADES",
	"ANOHAS" * 10000 + "MESHAS" * 100 + "DIAHAS"
);
CREATE INDEX "MIGRA"."PK_HJPF02_FEC3" ON "MIGRA"."HJPF02" (
	"RAMO","POLIZA","NUMREC",
	"ANODES" * 10000 + "MESDES" * 100 + "DIADES",
	"ANOHAS" * 10000 + "MESHAS" * 100 + "DIAHAS"
);
...
CREATE INDEX "MIGRA"."PK_HJPF02_FEC1" ON "MIGRA"."HJPF01" (
	"RAMO","POLIZA",
	"ANODES" * 10000 + "MESDES" * 100 + "DIADES",
	"ANOHAS" * 10000 + "MESHAS" * 100 + "DIAHAS"
);
...
CREATE INDEX "MIGRA"."INDX_MIGRA_MED" ON "MIGRA"."AMPF02" ("RAMO","POLIZA","SERIE","RECLAC","RECLAM");
CREATE INDEX "MIGRA"."IDX$$_15D70001" ON "MIGRA"."AMPF02" ("RAMO");
CREATE INDEX "MIGRA"."IND1_AMPF02" ON "MIGRA"."AMPF02" ("RAMO","POLIZA","STSREC","NUMREC","CERTIF","CODBEN");
CREATE INDEX "MIGRA"."IND2_AMPF02" ON "MIGRA"."AMPF02" ("RAMO","POLIZA","STSREC","NUMREC","CERTIF");
CREATE INDEX "MIGRA"."IND3_AMPF02" ON "MIGRA"."AMPF02" ("RAMO","POLIZA","STSREC","NUMREC");
CREATE INDEX "MIGRA"."IND4_AMPF02" ON "MIGRA"."AMPF02" ("RAMO","POLIZA");

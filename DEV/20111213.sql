...
CREATE INDEX "MIGRAREN"."IDX_RAP ON UCODANO" ON "MIGRAREN"."CLPF37" ("RAMO","POLIZA","NUMCER","CODEST","CODCLA","ANO");
...
CREATE INDEX "MIGRAREN"."IDX$$_19710001" ON "MIGRAREN"."FNPF06" ("NUMC ON ");
...
CREATE INDEX "MIGRAREN"."PK_RBPF10" ON "MIGRAREN"."RBPF10" ("CPLREC","Z ON REC","NMRRCL","RAMO","POLIZA","CDGREC");
CREATE INDEX "MIGRAREN"."INDX_SIN" ON "MIGRAREN"."RBPF10" ("RAMO","POLIZA","SERIE","RECLAC","RECLAM");
CREATE INDEX "MIGRAREN"."PK_REPF14" ON "MIGRAREN"."REPF14" ("RAMO","POLIZA","STSREC","NUMREC","TIPC ON ");
CREATE INDEX "MIGRAREN"."REPF14_INDEX_02" ON "MIGRAREN"."REPF14" ("RAMO","POLIZA","NUMREC");
CREATE INDEX "MIGRAREN"."PK_REPF15" ON "MIGRAREN"."REPF15" ("RAMO","POLIZA","STSREC","NUMREC","TIPC ON ","NUMCES","CODRF");
...
CREATE INDEX "MIGRAREN"."IDX_RAP ON UVER" ON "MIGRAREN"."HJPF09A" ("RAMO","POLIZA","NUMREC","VERCIH","ANOF");
...
CREATE INDEX "MIGRAREN"."PK_IMPF01" ON "MIGRAREN"."IMPF01" ("SUCC ON ","VOERIF","RIF");
CREATE INDEX "MIGRAREN"."PK_IMPF01_2" ON "MIGRAREN"."IMPF01" ("TIPC ON ");
...
CREATE INDEX "MIGRAREN"."IDX$$_11F20001" ON "MIGRAREN"."GIPF01" ("NACI ON ","CDDEU");
...
CREATE INDEX "MIGRAREN"."PK_GIPF03" ON "MIGRAREN"."GIPF03" ("CDCIA","NACI ON ","CDDEU","NRREG");

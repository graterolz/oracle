...
CREATE INDEX "MIGRA"."PK_RBPF10" ON "MIGRA"."RBPF10" ("CPLREC","Z ON REC","NMRRCL","RAMO","POLIZA","CDGREC");
CREATE INDEX "MIGRA"."INDX_SIN" ON "MIGRA"."RBPF10" ("RAMO","POLIZA","SERIE","RECLAC","RECLAM");
CREATE INDEX "MIGRA"."PK_REPF14" ON "MIGRA"."REPF14" ("RAMO","POLIZA","STSREC","NUMREC","TIPC ON ");
CREATE INDEX "MIGRA"."REPF14_INDEX_02" ON "MIGRA"."REPF14" ("RAMO","POLIZA","NUMREC");
CREATE INDEX "MIGRA"."PK_REPF15" ON "MIGRA"."REPF15" ("RAMO","POLIZA","STSREC","NUMREC","TIPC ON ","NUMCES","CODRF");
...
CREATE INDEX "MIGRA"."PK_IMPF01" ON "MIGRA"."IMPF01" ("SUCC ON ","VOERIF","RIF");
CREATE INDEX "MIGRA"."PK_IMPF01_2" ON "MIGRA"."IMPF01" ("TIPC ON ");
...
CREATE INDEX "MIGRA"."IDX$$_11F20001" ON "MIGRA"."GIPF01" ("NACI ON ","CDDEU");
...
CREATE INDEX "MIGRA"."PK_GIPF03" ON "MIGRA"."GIPF03" ("CDCIA","NACI ON ","CDDEU","NRREG");
CREATE INDEX "MIGRA"."IDX_GIPF03" ON "MIGRA"."GIPF03" ("NRREG","RAMO","POLIZA","NUMREC");
CREATE INDEX "MIGRA"."IDX$$_23670001" ON "MIGRA"."GIPF16" ("CDDEU","NACI ON ");
...
CREATE INDEX "MIGRA"."IDX_RAP ON UVER" ON "MIGRA"."HJPF09A" ("RAMO","POLIZA","NUMREC","VERCIH","ANOF");
...
CREATE INDEX "MIGRA"."IDX_RAP ON UCODANO" ON "MIGRA"."CLPF37" ("RAMO","POLIZA","NUMCER","CODEST","CODCLA","ANO");
...
CREATE INDEX "MIGRA"."IDX$$_19710001" ON "MIGRA"."FNPF06" ("NUMC ON ");
